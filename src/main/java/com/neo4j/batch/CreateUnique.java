...
public class CreateUnique implements AutoCloseable {
	
	private final Driver driver;

	public CreateUnique( String uri, String user, String password )
	{
            ...
            try (Transaction tx = session.beginTransaction())
            {
            	if(seq == 1) {
            		...
            		tx.run(
            				...
            				"return r,n\",\"\r\n" + 
            				"merge (n)-[y:O_Acheive]->(r)\r\n" + 
            				"merge (r)-[z:Affiliation]->(n)\r\n" + 
            				"\",{batchSize:10000, parallel:false})"
            				);
            	}else if(seq == 3) {
            		tx.run(
